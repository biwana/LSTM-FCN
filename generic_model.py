...
if __name__ == "__main__":
    ...
    train_model(model, dataset, method, proto_num, dataset_prefix=dataset, epochs=8000, batch_size=64)

    evaluate_model(model, dataset, method, proto_num, dataset_prefix=dataset, batch_size=64)
